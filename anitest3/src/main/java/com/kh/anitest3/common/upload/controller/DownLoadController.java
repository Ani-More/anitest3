package com.kh.anitest3.common.upload.controller;
...
import com.kh.anitest3.common.upload.FileStore;
...
public class DownLoadController {
	 ...
	 */
	@ResponseBody	//http응답 메세지 바디에 직접 내용쓰기
	...
	public ResponseEntity<Resource> downloadAttach(
		...
		//Http응답 메세지 헤더에 첨부파일이 있음을 알림. 규약이기때문에 형식은 똑같이 따라줘야하는 부분
